...
OPTRACE "Route Design: post hook" START { }
  ...
  if {$src_rc} { 
    ...
    send_msg_id runtcl-2 error "sourcing script E:/ARCHIVOS_Y_DOCUMENTOS/01_Tesis_Local/PEATC_Xillinux/PEATC_Xillinux/vivado-essentials/showstopper.tcl failed"
    return -code error
  }
