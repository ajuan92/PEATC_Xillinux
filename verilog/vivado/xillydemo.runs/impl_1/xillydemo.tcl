...
namespace eval ::optrace {
  variable script "E:/ARCHIVOS_Y_DOCUMENTOS/01_Tesis_Local/PEATC_Xillinux/PEATC_Xillinux/verilog/vivado/xillydemo.runs/impl_1/xillydemo.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet E:/ARCHIVOS_Y_DOCUMENTOS/01_Tesis_Local/PEATC_Xillinux/PEATC_Xillinux/verilog/vivado/xillydemo.runs/synth_1/xillydemo.dcp
...
OPTRACE "Route Design: post hook" START { }
  set src_rc [catch { 
    puts "source E:/ARCHIVOS_Y_DOCUMENTOS/01_Tesis_Local/PEATC_Xillinux/PEATC_Xillinux/vivado-essentials/showstopper.tcl"
  ...
  if {$src_rc} { 
    ...
    if { $tool_flow eq {SDx} } { 
      ...
      send_gid_msg -id 3 -ssname VPL_TCL -severity ERROR "sourcing script E:/ARCHIVOS_Y_DOCUMENTOS/01_Tesis_Local/PEATC_Xillinux/PEATC_Xillinux/vivado-essentials/showstopper.tcl failed"
    } else {
      send_msg_id runtcl-1 status "$_RESULT"
      send_msg_id runtcl-2 status "sourcing script E:/ARCHIVOS_Y_DOCUMENTOS/01_Tesis_Local/PEATC_Xillinux/PEATC_Xillinux/vivado-essentials/showstopper.tcl failed"
    }
    return -code error
  }
