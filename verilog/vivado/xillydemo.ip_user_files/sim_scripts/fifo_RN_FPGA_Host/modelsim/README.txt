...
#
# Generated by export_simulation on Thu Jan 13 22:57:05 -0600 2022
#
################################################################################
...
'-reset_run' switch to the './fifo_RN_FPGA_Host.sh' script.

./fifo_RN_FPGA_Host.sh -reset_run
...
./fifo_RN_FPGA_Host.sh -noclean_files

For more information on the script, please type './fifo_RN_FPGA_Host.sh -help'.
