...
#
# Generated by export_simulation on Sun Oct 17 18:43:45 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './fifo_GS_Host_FPGA.sh' script.

./fifo_GS_Host_FPGA.sh -reset_run
...
./fifo_GS_Host_FPGA.sh -noclean_files

For more information on the script, please type './fifo_GS_Host_FPGA.sh -help'.
