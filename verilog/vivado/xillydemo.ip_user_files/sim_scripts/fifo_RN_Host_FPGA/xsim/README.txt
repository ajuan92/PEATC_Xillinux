...
#
# Generated by export_simulation on Sun Jan 09 16:44:35 -0600 2022
#
################################################################################
...
'-reset_run' switch to the './fifo_RN_Host_FPGA.sh' script.

./fifo_RN_Host_FPGA.sh -reset_run
...
./fifo_RN_Host_FPGA.sh -noclean_files

For more information on the script, please type './fifo_RN_Host_FPGA.sh -help'.
