...
// Command     : write_verilog -force -mode synth_stub -rename_top fifo_GS_Host_RX_n -prefix
//               fifo_GS_Host_RX_n_ fifo_GS_Host_FPGA_stub.v
...
module fifo_GS_Host_RX_n(clk, srst, din, wr_en, rd_en, dout, full, empty)
