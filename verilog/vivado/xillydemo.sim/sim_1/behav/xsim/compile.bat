...
REM
REM Generated by Vivado on Fri Jan 28 00:13:35 -0600 2022
...
echo "xvlog --incr --relax -L uvm -L axi_vip_v1_1_11 -L processing_system7_vip_v1_0_13 -L xilinx_vip -prj GS_TestBench_vlog.prj"
call xvlog  --incr --relax -L uvm -L axi_vip_v1_1_11 -L processing_system7_vip_v1_0_13 -L xilinx_vip -prj GS_TestBench_vlog.prj -log xvlog.log
